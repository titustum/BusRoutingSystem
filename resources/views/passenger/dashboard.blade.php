    ...
    <div class="flex flex-col w-full h-screen p-4 pb-6 mt-16">
        ...
        <form method="POST" action="{{ route('journeys.search') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="origin" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" name="origin" :value="old('origin')" required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="destination" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" name="destination" :value="old('destination')" required />
